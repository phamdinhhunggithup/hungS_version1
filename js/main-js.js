...
$(document).ready(function() {
	var valueNameCustom;
	$("#post-new .modal-body button[type='submit']").click(function() {
		valueNameCustom = $("#post-new .modal-body input#username").val();
		alert('HungS.vn xin chào ' + valueNameCustom  + ' chúc bạn có một buổi mua sắp vui vẻ nhé !');
	});
});